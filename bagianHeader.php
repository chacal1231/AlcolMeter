...
<head>
    <meta charset="utf-8">	
	<link rel="icon" href="backend/images/icsono.png" />
        ...
        <header class="header fixed-top clearfix">
            ...
            <div class="brand">
                 <a href="index.php" class="logo">
                    <img src="backend/panel/imagess/logo.png" alt="" width="210" height="75">
                </a>
                    ...
                    <div class="leftside-navigation">
                        <ul class="sidebar-menu" id="nav-accordion">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li><a href="?page=evaluar">Evaluar paciente</a></li>
                                    <li><a href="?page=registro">Registros</a></li> 
                                </ul>
                            </li>
                            <li>
                                <a href="?page=setting">
